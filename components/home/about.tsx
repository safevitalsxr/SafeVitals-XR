    ...
    <section className="bg-background py-40 border-t border-border/50">
      <div className="section-shell">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="font-sans text-2xl text-text-secondary leading-relaxed mb-24 max-w-4xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 border-t border-border/50 pt-16 mb-24 max-w-4xl">
            <div>
          ...
          <div className="pt-16 border-t border-border/50">
            <h3 className="font-mono text-base text-accent mb-10 uppercase tracking-widest">Meet the Team</h3>
            <TeamCarousel />
          </div>
